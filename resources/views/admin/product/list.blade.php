...
@section('main_content')
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <div class="input-group">
                                    <div class="form-line">
                                        <input type="text"  name="trademark" value="{{$trademark}}" placeholder="Nhập tên nhãn hàng">
                                        @error('trademark')
                                            <div style="color: red">{{ $message }}</div>
                                        @enderror
                                    </div>
    ...
    <div class="card">
        ...
        <div class="body table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Amount</th>
                        <th class="center">
                            <a href="{{ route('admin.product.add') }}"><i class="material-icons">person_add</i>ADD</a>
                        </th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <a class="btn bg-green waves-effect"
                                    href="{{ route('admin.product.detail', ['id' => $product->id]) }}"><i
                                        class="material-icons">search</i></a>
                                <a class="btn bg-pink waves-effect"
                                    href="{{ route('admin.product.update', ['id' => $product->id]) }}"><i
            ...
            {{ $productList->links('admin.components.pagination') }}
            <a class=" btn bg-red waves-effect" href="{{ route('admin.product.detail_bin') }}"><i
